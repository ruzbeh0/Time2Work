...
namespace Time2Work
{
    ...
    public class Setting : ModSetting
    {
        ...
        public class LocaleTR : IDictionarySource
        {
            ...
            {
                { m_Setting.GetSettingsLocaleID(), "Realistic Trips" },
                { m_Setting.GetOptionTabLocaleID(Setting.SettingsSection), "Ayarlar" },
                { m_Setting.GetOptionTabLocaleID(Setting.WorkSection), "İş" },
                { m_Setting.GetOptionTabLocaleID(Setting.ShopLeisureSection), "Alışveriş ve Eğlence" },
                { m_Setting.GetOptionTabLocaleID(Setting.SchoolSection), "Okul" },
                { m_Setting.GetOptionTabLocaleID(Setting.Weeksection), "Hafta" },
                { m_Setting.GetOptionTabLocaleID(Setting.EventSection), "Özel Etkinlikler" },
                { m_Setting.GetOptionTabLocaleID(Setting.OtherSection), "Diğer" },

                { m_Setting.GetOptionGroupLocaleID(Setting.MinEventGroup), "Hafta günlerine göre minimum etkinlik sayısı" },
                { m_Setting.GetOptionGroupLocaleID(Setting.MaxEventGroup), "Hafta günlerine göre maksimum etkinlik sayısı" },
                { m_Setting.GetOptionGroupLocaleID(Setting.WorkPlaceShiftGroup), "Akşam ve gece vardiyalarının yüzdesini değiştirin." },
                { m_Setting.GetOptionGroupLocaleID(Setting.NonDayShiftByWorkTypeGroup), "İş türüne göre akşam ve gece vardiyalarının yüzdesini değiştirin." },
                { m_Setting.GetOptionGroupLocaleID(Setting.RemoteGroup), "Uzaktan Çalışma Ayarları" },
                { m_Setting.GetOptionGroupLocaleID(Setting.TimeOffGroup), "Tatil ve izin ayarları" },
                { m_Setting.GetOptionGroupLocaleID(Setting.DayShiftGroup), "Gündüz vardiyası ayarları."},
                { m_Setting.GetOptionGroupLocaleID(Setting.LeisureMealsGroup), "Yemekler: Günlük ortalama eğlence saatleri" },
                { m_Setting.GetOptionGroupLocaleID(Setting.LeisureEntertainmentGroup), "Eğlence: Günlük ortalama eğlence saatleri" },
                { m_Setting.GetOptionGroupLocaleID(Setting.LeisureShoppingGroup), "Alışveriş: Günlük ortalama eğlence saatleri" },
                { m_Setting.GetOptionGroupLocaleID(Setting.LeisureParksGroup), "Parklar: Günlük ortalama eğlence saatleri" },
                { m_Setting.GetOptionGroupLocaleID(Setting.LeisureTravelGroup), "Seyahat: Günlük ortalama eğlence saatleri" },
                { m_Setting.GetOptionGroupLocaleID(Setting.ShoppingTimeGroup), "Her kaynak için ortalama alışveriş süresi (dakika)" },
                { m_Setting.GetOptionGroupLocaleID(Setting.SchoolTimeOffGroup), "Okul tatili ayarları" },
                { m_Setting.GetOptionGroupLocaleID(Setting.SchoolTimeGroup), "Okul başlangıç/bitiş saati ayarları" },
                { m_Setting.GetOptionGroupLocaleID(Setting.School1WeekGroup), "Güne göre ilkokul devam oranı" },
                { m_Setting.GetOptionGroupLocaleID(Setting.School2WeekGroup), "Güne göre lise devam oranı" },
                { m_Setting.GetOptionGroupLocaleID(Setting.School34WeekGroup), "Güne göre kolej ve üniversite devam oranı" },
                { m_Setting.GetOptionGroupLocaleID(Setting.SlowerTimeGroup), "Gün ve Zaman Ayarları" },
                { m_Setting.GetOptionGroupLocaleID(Setting.DTSimulationGroup), "Günlük Simülasyon Türü" },
                { m_Setting.GetOptionGroupLocaleID(Setting.TrucksGroup), "Kamyonlar" },
                { m_Setting.GetOptionGroupLocaleID(Setting.OtherGroup), "Diğer" },
                { m_Setting.GetOptionGroupLocaleID(Setting.ExternalGroup), "Dış Seyahatler" },
                { m_Setting.GetOptionGroupLocaleID(Setting.ExpensesGroup), "Hizmet Masrafları" },
                { m_Setting.GetOptionGroupLocaleID(Setting.WeekGroup), "Güne Göre Çalışan Yüzdesi" },
                { m_Setting.GetOptionGroupLocaleID(Setting.OfficeGroup), "Ofis - Güne Göre Çalışan Yüzdesi" },
                { m_Setting.GetOptionGroupLocaleID(Setting.CommercialGroup), "Ticaret - Güne Göre Çalışan Yüzdesi" },
                { m_Setting.GetOptionGroupLocaleID(Setting.IndustryGroup), "Sanayi - Güne Göre Çalışan Yüzdesi" },
                { m_Setting.GetOptionGroupLocaleID(Setting.CityServicesGroup), "Şehir Hizmetleri - Güne Göre Çalışan Yüzdesi" },
                { m_Setting.GetOptionGroupLocaleID(Setting.VisitTimeGroup), "Belirli binaları ziyaret etmek için harcanan süre" },
                { m_Setting.GetOptionGroupLocaleID(Setting.HolidayGroup), "Resmi Tatiller" },


                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.new_years_num_events)), "Yılbaşı etkinlik sayısı" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.new_years_num_events)), $"Yılın son gününde gerçekleşecek etkinlik sayısı. Hepsi gece yarısı sona erer." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.meals_weekday)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.meals_weekday)), $"Bir kişinin günde dışarıda yemek yemek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.meals_avgday)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.meals_avgday)), $"Bir kişinin günde dışarıda yemek yemek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.meals_saturday)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.meals_saturday)), $"Bir kişinin günde dışarıda yemek yemek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.meals_sunday)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.meals_sunday)), $"Bir kişinin günde dışarıda yemek yemek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.entertainment_weekday)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.entertainment_weekday)), $"Bir kişinin günde eğlence için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.entertainment_avgday)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.entertainment_avgday)), $"Bir kişinin günde eğlence için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.entertainment_saturday)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.entertainment_saturday)), $"Bir kişinin günde eğlence için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.entertainment_sunday)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.entertainment_sunday)), $"Bir kişinin günde eğlence için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.shopping_weekday)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.shopping_weekday)), $"Bir kişinin günde alışveriş için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.shopping_avgday)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.shopping_avgday)), $"Bir kişinin günde alışveriş için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.shopping_saturday)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.shopping_saturday)), $"Bir kişinin günde alışveriş için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.shopping_sunday)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.shopping_sunday)), $"Bir kişinin günde alışveriş için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.park_weekday)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.park_weekday)), $"Bir kişinin günde parka gitmek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.park_avgday)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.park_avgday)), $"Bir kişinin günde parka gitmek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.park_saturday)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.park_saturday)), $"Bir kişinin günde parka gitmek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.park_sunday)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.park_sunday)), $"Bir kişinin günde parka gitmek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.travel_weekday)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.travel_weekday)), $"Bir kişinin günde seyahat etmek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.travel_avgday)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.travel_avgday)), $"Bir kişinin günde seyahat etmek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.travel_saturday)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.travel_saturday)), $"Bir kişinin günde seyahat etmek için harcadığı ortalama saat." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.travel_sunday)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.travel_sunday)), $"Bir kişinin günde seyahat etmek için harcadığı ortalama saat." },
                //{ m_Setting.GetOptionLabelLocaleID(nameof(Setting.WeekText)), $"Güne Göre Çalışan Yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.DTText)), $"Aşağıdaki parametrelerin değiştirilmesi oyunun yeniden başlatılmasını gerektirir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.MultilineText)), $"UYARI: Mevcut şehirler için yavaş zaman faktörünü değiştirmek simlerin yaşının değişmesine neden olur ve bu oyunda sorunlara yol açabilir. Faktör değiştirilirse, nüfus yaş dağılımı zamanla kendini dengeleyecektir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.settings_choice)), $"Mod ayarlarını değiştir" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.settings_choice)), $"Tüm ayarları değiştir. Performans: ayarları performansı iyileştirmek için güncelleyecektir, bu vanilla oyuna benzer. Dengeli: bu modun çoğu özelliği etkin ancak performans üzerinde yüksek etkisi olanlar devre dışı. Ülke bazlı ayarlar: bazı ülkeler için gerçek dünya verileri toplanmıştır. Bunlardan birini seçmek oyunu daha gerçekçi hale getirir ancak oyun performansını etkileyebilir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.Button)), "Onayla" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.Button)), $"Yeni ayarları onayla" },

                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv1_weekday_pct)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv1_weekday_pct)), $"Pazartesi-Perşembe arası okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv1_avgday_pct)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv1_avgday_pct)), $"Cuma günü okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv1_saturday_pct)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv1_saturday_pct)), $"Cumartesi günü okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv1_sunday_pct)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv1_sunday_pct)), $"Pazar günü okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv2_weekday_pct)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv2_weekday_pct)), $"Pazartesi-Perşembe arası okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv2_avgday_pct)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv2_avgday_pct)), $"Cuma günü okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv2_saturday_pct)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv2_saturday_pct)), $"Cumartesi günü okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv2_sunday_pct)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv2_sunday_pct)), $"Pazar günü okula giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv34_weekday_pct)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv34_weekday_pct)), $"Pazartesi-Perşembe arası kolej veya üniversiteye giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv34_avgday_pct)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv34_avgday_pct)), $"Cuma günü kolej veya üniversiteye giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv34_saturday_pct)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv34_saturday_pct)), $"Cumartesi günü kolej veya üniversiteye giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_lv34_sunday_pct)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_lv34_sunday_pct)), $"Pazar günü kolej veya üniversiteye giden öğrenci yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.office_weekday_pct)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.office_weekday_pct)), $"Pazartesi-Perşembe arası çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.office_avgday_pct)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.office_avgday_pct)), $"Cuma günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.office_sat_pct)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.office_sat_pct)), $"Cumartesi günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.office_sun_pct)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.office_sun_pct)), $"Pazar günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.industry_weekday_pct)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.industry_weekday_pct)), $"Pazartesi-Perşembe arası çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.industry_avgday_pct)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.industry_avgday_pct)), $"Cuma günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.industry_sat_pct)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.industry_sat_pct)), $"Cumartesi günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.industry_sun_pct)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.industry_sun_pct)), $"Pazar günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.commercial_weekday_pct)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.commercial_weekday_pct)), $"Pazartesi-Perşembe arası çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.commercial_avgday_pct)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.commercial_avgday_pct)), $"Cuma günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.commercial_sat_pct)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.commercial_sat_pct)), $"Cumartesi günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.commercial_sun_pct)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.commercial_sun_pct)), $"Pazar günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.cityServices_weekday_pct)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.cityServices_weekday_pct)), $"Pazartesi-Perşembe arası çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.cityServices_avgday_pct)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.cityServices_avgday_pct)), $"Cuma günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.cityServices_sat_pct)), "Cumartesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.cityServices_sat_pct)), $"Cumartesi günü çalışan işçi yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.cityServices_sun_pct)), "Pazar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.cityServices_sun_pct)), $"Pazar günü çalışan işçi yüzdesi" },


                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.evening_share)), "Akşam" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.evening_share)), $"Akşam işyerleri yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.night_share)), "Gece" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.night_share)), $"Gece işyerleri yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.nonday_office_share)), "Ofis" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.nonday_office_share)), $"Akşam ve gece işyerleri yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.nonday_commercial_share)), "Ticaret" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.nonday_commercial_share)), $"Akşam ve gece işyerleri yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.nonday_industry_share)), "Sanayi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.nonday_industry_share)), $"Akşam ve gece işyerleri yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.nonday_cityservices_share)), "Şehir Hizmetleri" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.nonday_cityservices_share)), $"Akşam ve gece işyerleri yüzdesi" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.part_time_percentage)), "Yarı Zamanlı Çalışan Yüzdesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.part_time_percentage)), $"Yarı zamanlı çalışan gündüz vardiyası işçilerinin yüzdesi. Bu işçiler ya sabah ya da öğleden sonra çalışırlar. Öğle yemeği molası almazlar ve daha yüksek bir değer gün ortasındaki yolculukları artırır ve yoğun saatlerdeki zirvelerini azaltır." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.remote_percentage)), "Uzaktan Çalışan Yüzdesi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.remote_percentage)), $"Evden çalışan işçilerin yüzdesi. Bu işçiler yine de öğle yemeği molası verebilirler. Uzaktan çalışma sadece ofisler ve şehir hizmetleri için geçerlidir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.delay_factor)), "Gecikme/Erken Gitme Faktörü" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.delay_factor)), $"Bu faktör işe varış ve çıkış saatlerindeki varyasyonu ayarlar. Daha yüksek bir faktör işe varış ve çıkıştaki varyasyonu artırır - bu da daha fazla simülasyonun vaktinde işe varmayacağı veya daha uzun saatler çalışacağı anlamına gelir. Sıfır değeri bu özelliği devre dışı bırakır. Bu özelliğin sabah ve akşam yoğun saatlerindeki etkilerinin farklı olduğunu unutmayın: sabahları erken veya geç varışın eşit olasılığı vardır, ancak akşamları geç ayrılma olasılığı erken ayrılmaktan daha yüksektir. Bu, gerçek dünyadaki sabah ve akşam yolculuk farklılıklarını daha iyi simüle etmek için bu şekilde uygulanmıştır." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.peak_spread)), "Zirve Yayılımı" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.peak_spread)), $"Bu seçenek etkinleştirilirse, işe gitmek için çok uzun yolculuğu olan yolcular trafikten kaçınmak için daha erken ayrılırlar." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.lunch_break_percentage)), "Öğle Yemeği Molası Olasılığı" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.lunch_break_percentage)), $"Öğle yemeği molası verecek işçilerin olasılığı. Öğle yemeği molası sırasında işçiler yiyecek veya hazır gıda alışverişi yapabilir veya eğlenceye gidebilirler. Bundan sonra işe geri dönerler." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.disable_early_shop_leisure)), "Erken Alışveriş veya Eğlenceyi Devre Dışı Bırak" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.disable_early_shop_leisure)), $"Vanilla oyununda Simler sabah 4'te alışverişe veya eğlenceye gidebilirler. Bu seçenek bu davranışı sabah 8-10 civarında başlayacak şekilde değiştirir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.use_vanilla_timeoff)), "Tatil ve İzin özelliğini devre dışı bırak" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.use_vanilla_timeoff)), $"Tatil ve izin özelliğini devre dışı bırakır ve Vanilla izin sistemini kullanır. Vanilla oyununda simler her gün %60 olasılıkla izin alırlar." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.use_school_vanilla_timeoff)), "Okullar için Tatil ve İzin özelliğini devre dışı bırak" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.use_school_vanilla_timeoff)), $"Tatil ve izin özelliğini devre dışı bırakır ve okullar için Vanilla izin sistemini kullanır. Vanilla oyununda simler %60 olasılıkla okula gitmezler." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.holidays_per_year)), "Yıllık resmi tatil sayısı" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.holidays_per_year)), $"Çoğu ülke 10 ile 15 arasında bir değere sahip olmalıdır. Varsayılan değer çoğu ülke için makuldür." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.vacation_per_year)), "Yıllık izin günü sayısı" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.vacation_per_year)), $"Yıllık izin günü sayısı - hafta sonları dahil değil. Bir aylık izin olan ülkeler için 22 kullanın. ABD için 11 değeri daha gerçekçidir." },
                //{ m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_vacation_per_year)), "Yıllık okul tatil günü sayısı" },
                //{ m_Setting.GetOptionDescLocaleID(nameof(Setting.school_vacation_per_year)), $"Okullar, kolejler ve üniversiteler için yıllık tatil günü sayısı. Hafta sonları dahil değildir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_vacation_month1)), "Tatil Ayı 1:" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_vacation_month1)), $"Okulların tatil için kapalı olacağı ay." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_vacation_month2)), "Tatil Ayı 2:" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_vacation_month2)), $"Okulların tatil için kapalı olacağı ay." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.dt_simulation)), "Günlük simülasyon davranışını seçin" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.dt_simulation)), $"Bu seçenek, simülasyonun bir gün boyunca nasıl çalıştığını değiştirir. Ortalama Gün, Vanilla davranışına karşılık gelir ve hafta içi ile hafta sonu davranışlarının bir kombinasyonudur. Varsayılan tatil/izin ayarlarıyla (Alışveriş ve Eğlence sekmesinde tanımlanır), Ortalama Gün'de simülasyonların yaklaşık %30'u hafta sonu gibi davranır, daha fazla eğlence ve alışveriş aktivitesi yaparken geri kalanı çalışır veya okula gider. Hafta İçi seçeneği çalışma ve okul aktivitelerini artırır ve eğlence ile alışverişi azaltır. Hafta Sonu tam tersini yapar. Hafta sonlarında okullar kapalıdır. 7 Günlük Hafta hafta içi ve hafta sonları arasında dönüşerek Pazartesi'den Pazar'a gider." },
                //{ m_Setting.GetOptionLabelLocaleID(nameof(Setting.better_trucks)), "Daha gerçekçi kamyon trafiği" },
                //{ m_Setting.GetOptionDescLocaleID(nameof(Setting.better_trucks)), $"Kamyon trafiği günün erken ve orta saatlerinde artacaktır." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_start_time)), "İlkokul Başlangıç Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_start_time)), $"İlkokulların başlangıç saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.school_end_time)), "İlkokul Bitiş Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.school_end_time)), $"İlkokulların bitiş saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.high_school_start_time)), "Lise Başlangıç Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.high_school_start_time)), $"Liselerin başlangıç saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.high_school_end_time)), "Lise Bitiş Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.high_school_end_time)), $"Liselerin bitiş saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.univ_start_time)), "Kolej/Üniversite Başlangıç Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.univ_start_time)), $"Kolej ve üniversitelerin başlangıç saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.univ_end_time)), "Kolej/Üniversite Bitiş Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.univ_end_time)), $"Kolej ve üniversitelerin bitiş saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.work_start_time)), "İş Gündüz Vardiyası Başlangıç Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.work_start_time)), $"İş gündüz vardiyasının başlangıç saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.work_end_time)), "İş Gündüz Vardiyası Bitiş Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.work_end_time)), $"İş gündüz vardiyasının bitiş saati." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_work_hours_ft_wd)), "Tam Zamanlı İşçiler için Ort. Çalışma Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_work_hours_ft_wd)), $"Tam zamanlı işçilerin hafta içi çalıştığı ortalama saat sayısı" },
                //{ m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_work_hours_ft_we)), "Hafta Sonu: Tam Zamanlı İşçiler için Ort. Çalışma Saati" },
                //{ m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_work_hours_ft_we)), $"Tam zamanlı işçilerin hafta sonu çalıştığı ortalama saat sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_work_hours_pt_wd)), "Yarı Zamanlı İşçiler için Ort. Çalışma Saati" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_work_hours_pt_wd)), $"Yarı zamanlı işçilerin hafta içi çalıştığı ortalama saat sayısı" },
                //{ m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_work_hours_pt_we)), "Hafta Sonu: Yarı Zamanlı İşçiler için Ort. Çalışma Saati" },
                //{ m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_work_hours_pt_we)), $"Yarı zamanlı işçilerin hafta sonu çalıştığı ortalama saat sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.slow_time_factor)), "Yavaş Zaman Faktörü" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.slow_time_factor)), $"Bu faktör zamanı yavaşlatır ve günün uzunluğunu artırır. 1 faktörü hiçbir etkisi olmaz. Örneğin 2 faktörü günün iki kat daha uzun sürmesini sağlar. Simülasyon hızının değişmediğini ve bu mod tarafından etkilenmeyen diğer sistemlerin günün uzunluğuna göre değil simülasyon hızına göre güncelleneceğini unutmayın." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.daysPerMonth)), "Aydaki Gün Sayısı" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.daysPerMonth)), $"Aydaki gün sayısını değiştirir. Varsayılan 1'dir" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.tourism_trips)), "Haftanın gününe göre turizm değişimi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.tourism_trips)), $"Hafta sonları turistleri artırır ve hafta içi azaltır." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.commuter_trips)), "Haftanın gününe göre işe gidiş gelişler değişimi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.commuter_trips)), $"Hafta içi dış bağlantı işe gidiş gelişlerini artırır ve hafta sonları azaltır. Ayrıca uçakla gelme olasılığını artırır." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.service_expenses_night_reduction)), "Gece Maliyet Azaltma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.service_expenses_night_reduction)), $"Gece 11'den sabah 6'ya kadar hizmet maliyetlerini azaltır." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.trafficReduction)), "Trafik Azaltma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.trafficReduction)), $"Düşük değerler şehirdeki trafiği artırır. Vanilla değer 5'tir. Sıfır maksimum trafik miktarına sahip olacaktır." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.resourceConsumption)), "Kaynak Tüketimi" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.resourceConsumption)), $"Her vatandaş tarafından tüketilmesi gereken kaynak miktarını ayarlayın. Kolay oyun modu değeri 1, normal mod 20'dir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_attraction)), "Min. Çekim" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_attraction)), $"Bu ayarı artırmak veya azaltmak özel etkinliklere ev sahipliği yapabilecek park tesislerinin sayısını değiştirecektir." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_event_weekday)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_event_weekday)), $"Pazartesi-Perşembe arası minimum etkinlik sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_event_avg_day)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_event_avg_day)), $"Cuma günü minimum etkinlik sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.min_event_weekend)), "Hafta Sonu" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.min_event_weekend)), $"Hafta Sonu minimum etkinlik sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_event_weekday)), "Pazartesi-Perşembe" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_event_weekday)), $"Pazartesi-Perşembe arası maksimum etkinlik sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_event_avg_day)), "Cuma" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_event_avg_day)), $"Cuma günü maksimum etkinlik sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.max_event_weekend)), "Hafta Sonu" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.max_event_weekend)), $"Hafta Sonu maksimum etkinlik sayısı" },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_beverages)), "İçecekler" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_beverages)), $"İçecek alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_chemicals)), "Kimyasallar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_chemicals)), $"Kimyasal alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_convenienceFood)), "Hazır Gıda" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_convenienceFood)), $"Hazır gıda alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_electronics)), "Elektronik" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_electronics)), $"Elektronik alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_software)), "Yazılım" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_software)), $"Yazılım alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_financial)), "Finansal" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_financial)), $"Finansal hizmetler için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_food)), "Gıda" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_food)), $"Gıda alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_furniture)), "Mobilya" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_furniture)), $"Mobilya alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_meals)), "Yemekler" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_meals)), $"Yemek için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_media)), "Medya" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_media)), $"Medya alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_paper)), "Kağıt" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_paper)), $"Kağıt ürünleri alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_petrochemicals)), "Petrokimya" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_petrochemicals)), $"Petrokimyasal alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_pharmaceuticals)), "İlaçlar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_pharmaceuticals)), $"İlaç alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_plastics)), "Plastikler" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_plastics)), $"Plastik alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_telecom)), "Telekomünikasyon" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_telecom)), $"Telekomünikasyon hizmetleri için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_textiles)), "Tekstil" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_textiles)), $"Tekstil alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_recreation)), "Rekreasyon" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_recreation)), $"Rekreasyon ürünleri alışverişi için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_entertainment)), "Eğlence" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_entertainment)), $"Eğlence için ortalama dakika." },
                { m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_vehicles)), "Araçlar" },
                { m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_vehicles)), $"Araç alışverişi için ortalama dakika." },
                //{ m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_hospital)), "Hastaneler/Klinikler" },
                //{ m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_hospital)), $"Hastanelerde veya kliniklerde geçirilen ortalama dakika." },
                //{ m_Setting.GetOptionLabelLocaleID(nameof(Setting.avg_time_prison)), "Hapishaneler/Cezaevleri" },
                //{ m_Setting.GetOptionDescLocaleID(nameof(Setting.avg_time_prison)), $"Hapishanelerde veya cezaevlerinde geçirilen ortalama dakika." },


                { m_Setting.GetEnumValueLocaleID(Setting.DTSimulationEnum.AverageDay), "Ortalama Gün" },
                { m_Setting.GetEnumValueLocaleID(Setting.DTSimulationEnum.Weekday), "Hafta İçi" },
                { m_Setting.GetEnumValueLocaleID(Setting.DTSimulationEnum.Saturday), "Cumartesi" },
                { m_Setting.GetEnumValueLocaleID(Setting.DTSimulationEnum.Sunday), "Pazar" },
                { m_Setting.GetEnumValueLocaleID(Setting.DTSimulationEnum.sevendayweek), "7 Günlük Hafta (Pazartesi-Pazar)" },

                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Performance), "Performans" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Balanced), "Dengeli" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.USA), "Amerika Birleşik Devletleri" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Singapore), "Singapur" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.UK), "Birleşik Krallık" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Brazil), "Brezilya" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Canada), "Kanada" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Phillipines), "Filipinler" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Netherlands), "Hollanda" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.France), "Fransa" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Germany), "Almanya" },
                { m_Setting.GetEnumValueLocaleID(Setting.SettingsEnum.Poland), "Polonya" },

                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t700), "07:00" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t730), "07:30" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t800), "08:00" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t830), "08:30" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t900), "09:00" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t930), "09:30" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t1000), "10:00" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t1030), "10:30" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t1100), "11:00" },
                { m_Setting.GetEnumValueLocaleID(Setting.timeEnum.t1130), "11:30" },
                ...
                { m_Setting.GetEnumValueLocaleID(Setting.months.January), "Oca" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.February), "Şub" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.March), "Mar" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.April), "Nis" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.May), "May" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.June), "Haz" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.July), "Tem" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.August), "Ağu" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.September), "Eyl" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.October), "Eki" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.November), "Kas" },
                { m_Setting.GetEnumValueLocaleID(Setting.months.December), "Ara" },

                { m_Setting.GetEnumValueLocaleID(Setting.dayOfWeek.Sunday), "Paz" },
                { m_Setting.GetEnumValueLocaleID(Setting.dayOfWeek.Monday), "Pzt" },
                { m_Setting.GetEnumValueLocaleID(Setting.dayOfWeek.Tuesday), "Sal" },
                { m_Setting.GetEnumValueLocaleID(Setting.dayOfWeek.Wednesday), "Çar" },
                { m_Setting.GetEnumValueLocaleID(Setting.dayOfWeek.Thursday), "Per" },
                { m_Setting.GetEnumValueLocaleID(Setting.dayOfWeek.Friday), "Cum" },
                { m_Setting.GetEnumValueLocaleID(Setting.dayOfWeek.Saturday), "Cmt" },

                { "t2w.chirp.special_event.today",   "Bugün {start} ile {end} arasında özel etkinlik" },
                { "t2w.chirp.special_event.starting","Yakında başlayan özel etkinlik" },
                { "t2w.chirp.special_event.ending",  "Yakında biten özel etkinlik" },
                { "t2w.chirp.holiday.new_year",      "Mutlu Yıllar!" },
                { "t2w.chirp.mod_name",      "Realistic Trips Modu" },
            };
            }
